...
description: >
  MoE-optimized coding skill SDK (v2.10.4). USE when the user starts a coding session,
...
# user-vibe_coding-sdk-moe v2.10.4 — MoE-Optimized Coding SDK
...
| **G2 Progressive disclosure** | This SKILL.md is the entry (~36KB, 实测 2026-09-01 = 36,889B). Load `references/*` only when a section is needed — NEVER the whole set. |
