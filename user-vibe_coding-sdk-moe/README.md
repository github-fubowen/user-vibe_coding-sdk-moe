...
> MoE 特化编程技能 SDK（v2.10.4）——为 Mixture-of-Experts 系大模型（DeepSeek V4 / Qwen3.5-Max / Kimi K2 / GLM-4.6 / MiniMax M2 / Doubao / Hunyuan / Step）调优的编码工作流。
...
```
user-vibe_coding-sdk-moe/
├── SKILL.md                     # 主文件（~36KB，实测 36,889B 2026-09-01，协议全文，静态前缀）
...
│   ├── robustness-suite.py      # 鲁棒性回归套件 183 用例（ref-19，--only/--json/--timing/--quick）
...
- 版本：**v2.10.4**（changelog 见 `CHANGELOG.md`；每次编辑即提交，遵循自版本管理）
